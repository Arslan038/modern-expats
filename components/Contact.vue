    ...
    <div class="container mx-auto px-6">
      <div class="text-center mb-16 scroll-reveal">
        ...
        <p class="font-body text-xl text-secondary-foreground/80 max-w-3xl mx-auto leading-relaxed">
          The world isn’t meant to be visited, it’s meant to be lived. Let us guide your visa path so you can belong
          anywhere, and build a life without borders built by nomads, for nomads.
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <form class="space-y-6" @submit.prevent="submitContact">
              <div>
                <input v-model="form.name" type="text" placeholder="Your Full Name" required
                  class="w-full px-4 py-3 rounded-lg border border-gray-300 bg-gray-50 text-foreground focus:ring-2 focus:ring-primary focus:border-primary transition-all duration-300" />
              </div>
              <div>
                <input v-model="form.email" type="email" placeholder="Your Email Address" required
                  class="w-full px-4 py-3 rounded-lg border border-gray-300 bg-gray-50 text-foreground focus:ring-2 focus:ring-primary focus:border-primary transition-all duration-300" />
              </div>
              <div>
                <input v-model="form.destination" type="text" placeholder="Your Destination" required
                  class="w-full px-4 py-3 rounded-lg border border-gray-300 bg-gray-50 text-foreground focus:ring-2 focus:ring-primary focus:border-primary transition-all duration-300" />
              </div>
              <div>
              ...
              <div>
                <textarea v-model="form.message" placeholder="Tell us about your travel plans and visa requirements..."
                  rows="5" required
                  class="w-full px-4 py-3 rounded-lg border border-gray-300 bg-gray-50 text-foreground focus:ring-2 focus:ring-primary focus:border-primary transition-all duration-300 resize-none"></textarea>
              </div>
              <button type="submit"
                class="w-full bg-gradient-to-r from-primary to-primary-deep text-primary-foreground font-body font-semibold py-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
        ...
        <div class="space-y-8 scroll-reveal">
            ...
            <div class="p-8">
              ...
              <div class="space-y-6">
                ...
                <div class="flex items-center">
                  ...
                  <div>
                    <div class="font-body font-semibold text-foreground">Response Time</div>
                    <div class="font-body text-muted-foreground">Within 24 hours</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="premium-card">
            <div class="p-8">
              <h3 class="font-display font-bold text-2xl text-foreground mb-6">Why Choose Us?</h3>
              ...
              <div class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <span class="font-body font-bold text-primary">4-6 weeks</span>
                </div>
                <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <span class="font-body font-bold text-primary">15+</span>
                </div>
              </div>
            </div>
          </div>
